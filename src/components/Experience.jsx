...
const ExperienceCard = ({experience}) => (
  <VerticalTimelineElement
    contentStyle={{background: '#58B2E6', color: '#fff'}} 
    contentArrowStyle={{borderRight: '7px solid #1b7eb8'}}
  ...
  return (
    <>
      <motion.div variants={textVariant}>  
        <p className={`${styles.sectionSubText} text-primary`}>My Past in the Field</p>
        <h2 className={`${styles.sectionHeadText} text-primary`}>
          RELATED EXPERIENCE.</h2>  
      </motion.div>
